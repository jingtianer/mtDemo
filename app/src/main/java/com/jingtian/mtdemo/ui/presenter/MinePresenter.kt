...
class MinePresenter : BasePresenter<MineInterface.View>(), MineInterface.Presenter {
    val function = arrayListOf(
        MineBean2(BaseApplication.utilsHolder.utils.getString(R.string.my_local), "我的位置", null),
        MineBean2(BaseApplication.utilsHolder.utils.getString(R.string.foot_print), "我的足迹", null),
        MineBean2(BaseApplication.utilsHolder.utils.getString(R.string.my_likes), "我的收藏", null),
        MineBean2(BaseApplication.utilsHolder.utils.getString(R.string.acknowledge_log), "答谢记录", null),
        MineBean2(BaseApplication.utilsHolder.utils.getString(R.string.comments), "我的评论", null),
        MineBean2(BaseApplication.utilsHolder.utils.getString(R.string.my_assistant), "我的客服", null),
        MineBean2(BaseApplication.utilsHolder.utils.getString(R.string.commercial), "理财", null),
        MineBean2(BaseApplication.utilsHolder.utils.getString(R.string.more), "更多", null),
    )
    ...
    private val assets = arrayListOf(
        MineBean1(
            true,
            SpannableString(BaseApplication.utilsHolder.utils.getString(R.string.red_bao)).apply {
        ...
        MineBean1(
            true,
            SpannableString(BaseApplication.utilsHolder.utils.getString(R.string.coupon)).apply {
                setSpan(AbsoluteSizeSpan(32, true), 0, 1, 0)
        ...
        MineBean1(
            true,
            SpannableString(BaseApplication.utilsHolder.utils.getString(R.string.allowance)).apply {
                setSpan(AbsoluteSizeSpan(32, true), 0, 1, 0)
                setSpan(
                    ForegroundColorSpan(
                        BaseApplication.utilsHolder.utils.getColor(
